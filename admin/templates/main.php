    ...
    <div class="row">
        <nav class="col-md-3 col-lg-2 flex-shrink-0 p-3 bg-light text-capitalize">
            <ul class="list-unstyled ps-0">
                ...
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#agent-collapse" aria-expanded="<?= $menu_section === 2 ? "true" : "false" ?>">
                        <?= _("Agents") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 2 ? "show" : "" ?>" id="agent-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_ADMINISTRATOR)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#admin-collapse" aria-expanded="<?= $menu_section === 3 ? "true" : "false" ?>">
                        <?= _("Admins") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 3 ? "show" : "" ?>" id="admin-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_SUPPORT)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#support-collapse" aria-expanded="<?= $menu_section === 4 ? "true" : "false" ?>">
                        <?= _("Support") ?>
                    </button>
                ...
                <?php if (Admin::allowed(Admin::ACX_CALL_REPORT)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#report-collapse" aria-expanded="<?= $menu_section === 5 ? "true" : "false" ?>">
                        <?= _("Call Reports") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 5 ? "show" : "" ?>" id="report-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a class="link-dark rounded" href="A2B_report_calls.php"><?= _("CDRs") ?></a></li>
                            <li><a class="link-dark rounded" href="A2B_report_call_counts.php"><?= _("Call Counts") ?></a></li>
                            <li><a class="link-dark rounded" href="A2B_report_trunk.php"><?= _("Trunk") ?></a></li>
                            <li><a class="link-dark rounded" href="A2B_report_dnid.php"><?= _("DNID") ?></a></li>
                            <li><a class="link-dark rounded" href="A2B_report_pnl.php"><?= _("PNL") ?></a></li>
                            <li><a class="link-dark rounded" href="A2B_report_comp.php"><?= _("Compare Calls") ?></a></li>
                ...
                <?php if (Admin::allowed(Admin::ACX_RATECARD)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#rate-collapse" aria-expanded="<?= $menu_section === 6 ? "true" : "false" ?>">
                        <?= _("Rates") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 6 ? "show" : "" ?>" id="rate-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_TRUNK)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#provider-collapse" aria-expanded="<?= $menu_section === 7 ? "true" : "false" ?>">
                        <?= _("Providers") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 7 ? "show" : "" ?>" id="provider-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_DID)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#did-collapse" aria-expanded="<?= $menu_section === 8 ? "true" : "false" ?>">
                        <?= _("Inbound DID") ?>
                    </button>
                ...
                <?php if (Admin::allowed(Admin::ACX_OUTBOUNDCID)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#cid-collapse" aria-expanded="<?= $menu_section === 9 ? "true" : "false" ?>">
                        <?= _("Outbound CID") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 9 ? "show" : "" ?>" id="cid-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_BILLING)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#billing-collapse" aria-expanded="<?= $menu_section === 10 ? "true" : "false" ?>">
                        <?= _("Billing") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 10 ? "show" : "" ?>" id="billing-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_INVOICING)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#invoice-collapse" aria-expanded="<?= $menu_section === 11 ? "true" : "false" ?>">
                        <?= _("Invoices") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 11 ? "show" : "" ?>" id="invoice-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_PACKAGEOFFER)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#package-collapse" aria-expanded="<?= $menu_section === 12 ? "true" : "false" ?>">
                        <?= _("Package Offer") ?>
                    </button>
                ...
                <?php if (Admin::allowed(Admin::ACX_CRONT_SERVICE)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#cron-collapse" aria-expanded="<?= $menu_section === 13 ? "true" : "false" ?>">
                        <?= _("Recur Service") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 13 ? "show" : "" ?>" id="cron-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_CALLBACK)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#callback-collapse" aria-expanded="<?= $menu_section === 14 ? "true" : "false" ?>">
                        <?= _("Callback") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 14 ? "show" : "" ?>" id="callback-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_MAINTENANCE)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#maintenance-collapse" aria-expanded="<?= $menu_section === 16 ? "true" : "false" ?>">
                        <?= _("Maintenance") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 16 ? "show" : "" ?>" id="maintenance-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <?php if (Admin::allowed(Admin::ACX_MAIL)): ?>
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#mail-collapse" aria-expanded="<?= $menu_section === 17 ? "true" : "false" ?>">
                        <?= _("Mail") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 17 ? "show" : "" ?>" id="mail-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                ...
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#setting-collapse" aria-expanded="<?= $menu_section === 18 ? "true" : "false" ?>">
                        <?= _("System Settings") ?>
                    </button>
                    <div class="collapse <?= $menu_section === 18 ? "show" : "" ?>" id="setting-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
