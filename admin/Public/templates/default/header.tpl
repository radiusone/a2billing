...
<head>
	...
	<script src="../lib/flot/js/jquery.flot.min.js"></script>
	<script src="../lib/flot/js/plugins/jquery.flot.time.min.js"></script>
	...
	<style>
		...
		.calendar_trigger svg, .popup_trigger svg {
			margin-top: 3px; /* 16px image in 24 px box */
			fill: currentColor;
		}
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
	...
	<symbol id="notify" viewBox="0 0 16 16">
	...
	<symbol id="calendar" viewBox="0 0 16 16" width="16" height="16">
		<path fill-rule="evenodd" d="M4.75 0a.75.75 0 01.75.75V2h5V.75a.75.75 0 011.5 0V2h1.25c.966 0 1.75.784 1.75 1.75v10.5A1.75 1.75 0 0113.25 16H2.75A1.75 1.75 0 011 14.25V3.75C1 2.784 1.784 2 2.75 2H4V.75A.75.75 0 014.75 0zm0 3.5h8.5a.25.25 0 01.25.25V6h-11V3.75a.25.25 0 01.25-.25h2zm-2.25 4v6.75c0 .138.112.25.25.25h10.5a.25.25 0 00.25-.25V7.5h-11z"></path>
	</symbol>
	<symbol id="popup" viewBox="0 0 16 16" width="16" height="16">
