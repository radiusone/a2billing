...
<div class="row pb-3 gx-5">
    <div class="col-6">
        <table class="table table-sm caption-top">
            <caption class="fw-bold fs-5"><?= _("Activity Log Info") ?></caption>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td><?= getLogLevel_List()[$log["loglevel"]] ?? $log["loglevel"] ?></td>
                </tr>
                <tr>
                    <th scope="row"><?= _("Action") ?></th>
                    <td><?= $log["action"] ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row"><?= _("IP address") ?></th>
                    <td><?= $log["ipaddress"] ?></td>
                </tr>
                <tr>
                    <th scope="row"><?= _("Date") ?></th>
                    <td><?= get_readable_date($log["creationdate"]) ?></td>
                </tr>
                <tr>
                    <th scope="row"><?= _("Data") ?></th>
                    <td><?= $log["data"] ?></td>
                </tr>
            </tbody>
        </table>
...
<div class="row pb-3 gx-5">
    <div class="col text-end">
        <a href="A2B_entity_log_viewer.php?form_action=list">
            <?= _("Return to log list") ?>
        </a>
    </div>
</div>
