...
$HD_Form->AddSearchComparisonInput(gettext("BUYRATE"), 'buyrate');
$HD_Form->AddSearchComparisonInput(gettext("RATE INITIAL"), 'rateinitial');
$HD_Form->prepare_list_subselection('list');
$HD_Form->AddSearchSqlSelectInput('SELECT TRUNK', "id_trunk", new Table("cc_trunk", ["trunkcode", "id_trunk"]));
$HD_Form->AddSearchSqlSelectInput("Source Ratecard", "idtariffplan", new Table("cc_tariffplan", ["tariffname", "id"]));
