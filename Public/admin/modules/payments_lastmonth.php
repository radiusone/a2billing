...
?>
<div class="card-text">
    <strong><?= _("Report Period") ?>:</strong>&nbsp;<label for="view_payment_day"><?= _("Days") ?></label>&nbsp;<input
            id="view_payment_day"
            type="radio"
            class="period_graph"
            name="view_payment"
...
<div class="card-text">
    <strong><?= _("Report Type") ?>:</strong>&nbsp;<label for="payments_count"><?= _("Payment Count") ?></label>&nbsp;<input
            id="payments_count"
            type="radio"
            name="mode_paym"
            class="update_graph"
