...
if (!$popup_select) {
?>
<a href="javascript:;" onClick="window.open('?popup_select=1&id=<?php echo $id ?>','','scrollbars=yes,resizable=yes,width=700,height=500')" > <img src="<?= get_image_path("printer.png", true) ?>" title="Print" alt="Print" border="0"></a>
&nbsp;&nbsp;
<a href="javascript:;" onClick="window.open('A2B_receipt_detail.php?popup_select=1&id=<?php echo $id ?>','','scrollbars=yes,resizable=yes,width=700,height=500')" > <img src="<?= get_image_path("info.png", true) ?>" title="Details" alt="Details" border="0"></a>
&nbsp;&nbsp;
<?php
}
?>
