    ...
    cellpadding="2" align="center">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            ?>: <INPUT TYPE="text"
                    ...
                    class="form_input_text">&nbsp;<a href="A2B_entity_card.php" class="btn btn-primary popup_trigger" aria-label="open a popup to select an item">&gt;</a>
                </td>
                <td width="50%">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
            ...
            echo $entertariffgroup?>" size="4" class="form_input_text">&nbsp;<a href="A2B_entity_tariffgroup.php" data-select="2" class="btn btn-primary popup_trigger" aria-label="open a popup to select an item">&gt;</a>
                        </td>
            ...
            echo $enterratecard?>" size="4"
                            class="form_input_text">&nbsp;<a href="A2B_entity_def_ratecard.php" data-select="2" class="btn btn-primary popup_trigger" aria-label="open a popup to select an item">&gt;</a>
                        </td>
