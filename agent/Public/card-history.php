...
if ($Period=="Month") {
    if ($frommonth && isset($fromstatsmonth)) $date_clause.=" AND ch.datecreated >= '$fromstatsmonth-01'";
    if ($tomonth && isset($tostatsmonth)) $date_clause.=" AND ch.datecreated <= '".$tostatsmonth."-$lastdayofmonth 23:59:59'";
} else {
                ...
                <TR class="form_head">
                  ...
                  <?php
                   ...
                   <td class="tableBody" style="padding: 2px;" align="center" width="<?php echo $FG_TABLE_COL[$i][2]?>" >
                        ...
                        <a href="<?php  echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)."?current_page=$current_page&order=".$FG_TABLE_COL[$i][1]."&sens="; if ($FG_SENS=="ASC") {echo"DESC";} else {echo"ASC";}
                        ...
                        &nbsp;<img src="<?= get_image_path("icon_up_12x12.GIF") ?>" border="0">
                        <?php } elseif ($FG_ORDER==$FG_TABLE_COL[$i][1] && $FG_SENS=="DESC") {?>
                        &nbsp;<img src="<?= get_image_path("icon_down_12x12.GIF") ?>" border="0">
                        <?php }?>
                        <?php  if (strtoupper($FG_TABLE_COL[$i][4])=="SORT") {?>
                        </font></a>
                        <?php }?>
