...
if (empty($id)) {
    header("Location: A2B_entity_payment_agent.php?section=10");
}
...
<table style="width : 80%;" class="editform_table1">
   ...
   <tr height="20px">
        ...
        <td class="tableBodyRight"  background="<?= get_image_path("background_cells.gif") ?>" width="70%">
            <?php echo Agent::getName($payment['agent_id'], false);?>
        </td>
   </tr>
   <tr height="20px">
        <td  class="form_head">
...
<div style="width : 80%; text-align : right; margin-left:auto;margin-right:auto;" >
     <a class="cssbutton_big"  href="A2B_entity_payment_agent.php?section=10">
