...
sqllist=(
    ...
    UPDATE-a2billing-v2.3.0-to-v3.0.0.sql UPDATE-a2billing-v3.0.0-to-v3.0.1.sql
    UPDATE-a2billing-v3.0.1-to-v3.1.0.sql UPDATE-a2billing-v3.1.0-to-v3.3.0.sql
)
